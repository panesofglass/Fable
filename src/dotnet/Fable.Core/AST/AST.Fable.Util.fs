...
let addWarning (com: ICompiler) (file: string) (range: SourceLocation option) (warning: string) =
    com.AddLog(warning, Warning, ?range=range, file=file)

let addError (com: ICompiler) (file: string) (range: SourceLocation option) (warning: string) =
    com.AddLog(warning, Error, ?range=range, file=file)
